...
3. Upload or link the safe files under `microsoft/knowledge/`.
4. Attach the Foundry IQ knowledge base to the Godspeed Foundry Agent Service agent.
5. Connect the Godspeed OpenAPI tool after endpoint and auth gates are approved.
6. Run these sample prompts:
