...
2. Foundry IQ knowledge base detail showing `godspeed-defense-mission-knowledge`.
3. Knowledge source list showing the safe Godspeed sources from `microsoft/knowledge/`.
4. Agent configuration showing the Foundry IQ knowledge base attached to the Godspeed agent.
5. OpenAPI tool configuration showing `createGodspeedCopilotMission` against the approved HTTPS endpoint.
